package com.example.android.mb24an.utilities;
...
public class ExcelUtils {
    ...
    public static boolean saveExcelFileForProjectTasks(Cursor cursor, Context context, String fileName, String projectName) {
    ...
    public static boolean saveExcelFileForSubjectTasks(Cursor cursor, Context context, String fileName, String subjectName) {
        ...
        sheet1.setColumnWidth(0, (15 * 100));
        sheet1.setColumnWidth(1, (15 * 500));
        sheet1.setColumnWidth(2, (15 * 900));
        sheet1.setColumnWidth(3, (15 * 500));
        sheet1.setColumnWidth(4, (15 * 500));
        sheet1.setColumnWidth(5, (15 * 1000));
        ...
        for(int i=0;i<cursor.getCount();i++){
            ...
            c = row.createCell(2);
            c.setCellValue(cursor.getString(cursor.getColumnIndex(Contract.TABLE_TASK.COLUMN_NAME_PROJECT_TITLE)));
